...
export default function OrphanageData() {
  ...
  const params = route.params as OrphanageParams;
   ...
   function handleCreateOrphanage() {
    ...
    //   })
      ...
      // await api.post('/oprhanages',data).then(res=>console.log(res));
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <TextInput
        style={styles.input}
        value={opening_hours} onChangeText={setOpeningHours}
      />
      ...
      <View style={styles.switchContainer}>
        ...
        <Switch
          ...
          value={open_on_weekends} onValueChange={setOpenOnWeekends}
        />
      </View>
